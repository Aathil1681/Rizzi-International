    ...
    <AnimatePresence>
      {searchOpen && (
        <>
          ...
          >
            {/* UPDATED: bg-black and border-gray-800 */}
              ...
              <div className="flex items-center gap-2 p-4">
                ...
                <div className="relative flex-grow">
                  <Search
                    ...
                    size={20}
                  />
                  {/* UPDATED: bg-gray-800, border-gray-700, focus:ring-white */}
                  <input
                    type="text"
                    autoFocus
                    value={searchQuery}
                    ...
                    className="w-full rounded-lg border border-gray-700 bg-gray-800 py-3 pl-11 pr-4 text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-white"
                  />
                </div>
                {/* UPDATED: bg-gray-800 and hover:bg-gray-600 */}
                <button
                  onClick={handleSearchClose}
                  className="flex-shrink-0 w-9 h-9 rounded-full bg-gray-800 flex items-center justify-center text-gray-100 hover:bg-gray-600 transition-colors"
